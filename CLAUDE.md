...
| **n8n-step-handlers**   | `.claude/skills/ag-n8n-step-handlers/SKILL.md` | N8n step handler subworkflows — handler contract (input/output shape, context preservation), supabaseRequest() boilerplate, payload flattening, alreadyPersisted flag, validation checklist for new handlers |
