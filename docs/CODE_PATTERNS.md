...
9. [Type Safety: Supabase Generic Types](#9-type-safety-supabase-generic-types)
10. [File Organization (ADR-005)](#10-file-organization-adr-005)
...
## 9. Type Safety: Supabase Generic Types

### The Problem: `any` Type is an Anti-Pattern

**Phase 4 Bug:** When querying with nested relations, Supabase returns generic JSON types.
...
### ✅ Solution: Define Proper Types for Supabase Responses
...
### When `as` Casting is Necessary

**Type mismatch scenarios where casting is unavoidable:**
