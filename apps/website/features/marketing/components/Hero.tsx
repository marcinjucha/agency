...
export function Hero() {
  ...
  return (
    <section className="relative min-h-screen bg-gradient-to-br from-blue-50 via-white to-blue-50 overflow-hidden pt-32 pb-20 md:pb-32 lg:pb-40">
      {/* Background decoration elements */}
      <div className="absolute top-0 right-0 w-96 h-96 bg-blue-100 rounded-full opacity-10 blur-3xl -z-10" />
          ...
          <div className="flex flex-col gap-8 animate-in fade-in slide-in-from-left-4 duration-700">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <Link href="/demo">
                <Button
                  size="lg"
                  className="bg-blue-600 hover:bg-blue-700 text-white shadow-lg hover:shadow-xl transition-shadow w-full sm:w-auto"
                >
                  Zarezerwuj demo
