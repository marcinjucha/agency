 ...
 *   'switch-1', 'send-email-1', 'delay-1'  — stable slugs for edge remapping
 *
...
export const WORKFLOW_TEMPLATES: WorkflowTemplate[] = [
    ...
    edges: [
      {
        ...
        target_temp_id: 'switch-1',
        condition_branch: null,
        sort_order: 0,
      },
      {
        source_temp_id: 'switch-1',
        target_temp_id: 'send-email-1',
        condition_branch: 'tak',
        sort_order: 1,
      },
    ],
  },
  ...
  // ====== Showcase Templates (AAA-T-211) — placeholder steps, never executed ======
  {
    ...
    steps: [
      ...
      },
      {
        ...
        position_x: 1700, position_y: 400,
      },
    ],
    edges: [
      ...
      { source_temp_id: 'ai-score',         target_temp_id: 'switch-tier',  condition_branch: null, sort_order: 6 },
      { source_temp_id: 'switch-tier',      target_temp_id: 'slack-hot',    condition_branch: 'hot',     sort_order: 7 },
      { source_temp_id: 'switch-tier',      target_temp_id: 'email-warm',   condition_branch: 'warm',    sort_order: 8 },
      { source_temp_id: 'switch-tier',      target_temp_id: 'email-cold',   condition_branch: 'default', sort_order: 9 },
      { source_temp_id: 'slack-hot',        target_temp_id: 'update-crm-hot',  condition_branch: null, sort_order: 10 },
      { source_temp_id: 'update-crm-hot',   target_temp_id: 'whatsapp-hot',    condition_branch: null, sort_order: 11 },
      { source_temp_id: 'email-warm',       target_temp_id: 'delay-warm',      condition_branch: null, sort_order: 12 },
      { source_temp_id: 'email-cold',       target_temp_id: 'email-sequence',  condition_branch: null, sort_order: 13 },
    ],
  },

  {
    ...
    edges: [
      ...
      { source_temp_id: 'ai-score',         target_temp_id: 'switch-score',    condition_branch: null,      sort_order: 2 },
      { source_temp_id: 'switch-score',     target_temp_id: 'delay-hot',       condition_branch: 'hot',     sort_order: 3 },
      { source_temp_id: 'switch-score',     target_temp_id: 'delay-warm',      condition_branch: 'warm',    sort_order: 4 },
      { source_temp_id: 'switch-score',     target_temp_id: 'update-crm-cold', condition_branch: 'default', sort_order: 5 },
      { source_temp_id: 'delay-hot',        target_temp_id: 'email-hot',       condition_branch: null,      sort_order: 6 },
      { source_temp_id: 'email-hot',        target_temp_id: 'whatsapp-hot',    condition_branch: null,      sort_order: 7 },
      { source_temp_id: 'delay-warm',       target_temp_id: 'email-warm',      condition_branch: null,      sort_order: 8 },
      { source_temp_id: 'update-crm-cold',  target_temp_id: 'email-sequence',  condition_branch: null,      sort_order: 9 },
    ],
  },

  {
    ...
    edges: [
      ...
      { source_temp_id: 'ai-analyze',        target_temp_id: 'switch-decision', condition_branch: null,      sort_order: 4 },
      { source_temp_id: 'switch-decision',   target_temp_id: 'ai-full-brief',   condition_branch: 'tak',     sort_order: 5 },
      { source_temp_id: 'switch-decision',   target_temp_id: 'ai-quick-brief',  condition_branch: 'default', sort_order: 6 },
...

  {
    ...
    edges: [
      ...
      { source_temp_id: 'ai-analysis',   target_temp_id: 'switch-anomaly', condition_branch: null,      sort_order: 3 },
      { source_temp_id: 'switch-anomaly', target_temp_id: 'slack-alert',   condition_branch: 'tak',     sort_order: 4 },
      { source_temp_id: 'switch-anomaly', target_temp_id: 'email-report',  condition_branch: 'default', sort_order: 5 },
...

  {
    ...
    edges: [
      ...
      { source_temp_id: 'delay-24h',          target_temp_id: 'switch-active',      condition_branch: null,      sort_order: 4 },
      { source_temp_id: 'switch-active',      target_temp_id: 'ai-personalized',    condition_branch: 'tak',     sort_order: 5 },
      { source_temp_id: 'switch-active',      target_temp_id: 'sms-reminder',       condition_branch: 'default', sort_order: 6 },
...

  {
    ...
    edges: [
      ...
      { source_temp_id: 'ai-score',            target_temp_id: 'switch-worth',       condition_branch: null,      sort_order: 2 },
      { source_temp_id: 'switch-worth',        target_temp_id: 'email-reactivate',   condition_branch: 'tak',     sort_order: 3 },
      { source_temp_id: 'switch-worth',        target_temp_id: 'update-crm-archive', condition_branch: 'default', sort_order: 4 },
...

  {
    ...
    edges: [
      ...
      { source_temp_id: 'ai-sentiment',      target_temp_id: 'switch-negative',   condition_branch: null,      sort_order: 2 },
      { source_temp_id: 'switch-negative',   target_temp_id: 'slack-alert',       condition_branch: 'tak',     sort_order: 3 },
      { source_temp_id: 'switch-negative',   target_temp_id: 'switch-new-review', condition_branch: 'default', sort_order: 4 },
      ...
      { source_temp_id: 'switch-new-review', target_temp_id: 'ai-auto-response',  condition_branch: 'tak',     sort_order: 8 },
      { source_temp_id: 'switch-new-review', target_temp_id: 'sheets-log',        condition_branch: 'default', sort_order: 9 },
    ],
  },

  {
    ...
    edges: [
      ...
      { source_temp_id: 'delay-webinar',    target_temp_id: 'switch-attended',   condition_branch: null,      sort_order: 1 },
      { source_temp_id: 'switch-attended',  target_temp_id: 'ai-summary',        condition_branch: 'tak',     sort_order: 2 },
      { source_temp_id: 'switch-attended',  target_temp_id: 'delay-replay',      condition_branch: 'default', sort_order: 3 },
      ...
      { source_temp_id: 'delay-replay',     target_temp_id: 'switch-replay',     condition_branch: null,      sort_order: 7 },
      { source_temp_id: 'switch-replay',    target_temp_id: 'email-replay',      condition_branch: 'tak',     sort_order: 8 },
      { source_temp_id: 'switch-replay',    target_temp_id: 'email-last-chance', condition_branch: 'default', sort_order: 9 },
...

  {
    ...
    edges: [
      ...
      { source_temp_id: 'delay-24h',        target_temp_id: 'switch-signed',    condition_branch: null,      sort_order: 4 },
      { source_temp_id: 'switch-signed',    target_temp_id: 'welcome-email',    condition_branch: 'tak',     sort_order: 5 },
      { source_temp_id: 'switch-signed',    target_temp_id: 'sms-reminder',     condition_branch: 'default', sort_order: 6 },
