...
// The value emitted by AddBlockPopover when the user picks a block to insert —
// always a real registry block type.
export type AddBlockPick = import('@agency/email').BlockType
